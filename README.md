# • Dot — Your Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Radix-Obsidian/Dot/main/docs/assets/dot-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/Radix-Obsidian/Dot/main/docs/assets/dot-logo-text.png" alt="Dot" width="500">
    </picture>
</p>

<p align="center">
  <strong>Connect the dots, bring all your channels together</strong>
</p>

<p align="center">
  <a href="https://github.com/dot/dot/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/dot/dot/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/dot/dot/releases"><img src="https://img.shields.io/github/v/release/dot/dot?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Dot** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://dot.ai) · [Docs](https://docs.dot.ai) · [Getting Started](https://docs.dot.ai/start/getting-started) · [Updating](https://docs.dot.ai/install/updating) · [Showcase](https://docs.dot.ai/start/showcase) · [FAQ](https://docs.dot.ai/start/faq) · [Wizard](https://docs.dot.ai/start/wizard) · [Docker](https://docs.dot.ai/install/docker) · [Discord](https://discord.gg/dot)

Preferred setup: run the onboarding wizard (`dot onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.dot.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.dot.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.dot.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.dot.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.dot.ai/start/getting-started)
...
# Send a message
dot message send --to +1234567890 --message "Hello from Dot"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
dot agent --message "Ship checklist" --thinking high
```
...
Switch channels (git + npm): `dot update --channel stable|beta|dev`.
Details: [Development channels](https://docs.dot.ai/install/development-channels).
...
```bash
git clone https://github.com/Radix-Obsidian/Dot.git
cd dot
...
pnpm dot onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm dot ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `dot` binary.

## Security defaults (DM access)

Dot connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.dot.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `dot pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `dot doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.dot.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.dot.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.dot.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.dot.ai/nodes/voicewake) + [Talk Mode](https://docs.dot.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.dot.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.dot.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.dot.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.dot.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.dot.ai/nodes).
- **[Onboarding](https://docs.dot.ai/start/wizard) + [skills](https://docs.dot.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=dot/dot&type=date&legend=top-left)](https://www.star-history.com/#dot/dot&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.dot.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.dot.ai/web), and [Canvas host](https://docs.dot.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.dot.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.dot.ai/start/wizard), and [doctor](https://docs.dot.ai/gateway/doctor).
- [Pi agent runtime](https://docs.dot.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.dot.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.dot.ai/concepts/groups).
- [Media pipeline](https://docs.dot.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.dot.ai/nodes/audio).

### Channels

- [Channels](https://docs.dot.ai/channels): [WhatsApp](https://docs.dot.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.dot.ai/channels/telegram) (grammY), [Slack](https://docs.dot.ai/channels/slack) (Bolt), [Discord](https://docs.dot.ai/channels/discord) (discord.js), [Google Chat](https://docs.dot.ai/channels/googlechat) (Chat API), [Signal](https://docs.dot.ai/channels/signal) (signal-cli), [iMessage](https://docs.dot.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.dot.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.dot.ai/channels/msteams) (extension), [Matrix](https://docs.dot.ai/channels/matrix) (extension), [Zalo](https://docs.dot.ai/channels/zalo) (extension), [Zalo Personal](https://docs.dot.ai/channels/zalouser) (extension), [WebChat](https://docs.dot.ai/web/webchat).
- [Group routing](https://docs.dot.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.dot.ai/channels).

### Apps + nodes

- [macOS app](https://docs.dot.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.dot.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.dot.ai/nodes/talk) overlay, [WebChat](https://docs.dot.ai/web/webchat), debug tools, [remote gateway](https://docs.dot.ai/gateway/remote) control.
- [iOS node](https://docs.dot.ai/platforms/ios): [Canvas](https://docs.dot.ai/platforms/mac/canvas), [Voice Wake](https://docs.dot.ai/nodes/voicewake), [Talk Mode](https://docs.dot.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.dot.ai/platforms/android): [Canvas](https://docs.dot.ai/platforms/mac/canvas), [Talk Mode](https://docs.dot.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.dot.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.dot.ai/tools/browser): dedicated dot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.dot.ai/platforms/mac/canvas): [A2UI](https://docs.dot.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.dot.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.dot.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.dot.ai/automation/cron-jobs); [webhooks](https://docs.dot.ai/automation/webhook); [Gmail Pub/Sub](https://docs.dot.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.dot.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.dot.ai/concepts/channel-routing), [retry policy](https://docs.dot.ai/concepts/retry), and [streaming/chunking](https://docs.dot.ai/concepts/streaming).
- [Presence](https://docs.dot.ai/concepts/presence), [typing indicators](https://docs.dot.ai/concepts/typing-indicators), and [usage tracking](https://docs.dot.ai/concepts/usage-tracking).
- [Models](https://docs.dot.ai/concepts/models), [model failover](https://docs.dot.ai/concepts/model-failover), and [session pruning](https://docs.dot.ai/concepts/session-pruning).
- [Security](https://docs.dot.ai/gateway/security) and [troubleshooting](https://docs.dot.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.dot.ai/web) + [WebChat](https://docs.dot.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.dot.ai/gateway/tailscale) or [SSH tunnels](https://docs.dot.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.dot.ai/install/nix) for declarative config; [Docker](https://docs.dot.ai/install/docker)-based installs.
- [Doctor](https://docs.dot.ai/gateway/doctor) migrations, [logging](https://docs.dot.ai/logging).
...
- **[Gateway WebSocket network](https://docs.dot.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.dot.ai/gateway)).
- **[Tailscale exposure](https://docs.dot.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.dot.ai/gateway/remote)).
- **[Browser control](https://docs.dot.ai/tools/browser)** — dot‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.dot.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.dot.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.dot.ai/nodes/voicewake) + [Talk Mode](https://docs.dot.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.dot.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

dot can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (dot enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.dot.ai/gateway/tailscale) · [Web surfaces](https://docs.dot.ai/web)
...
Details: [Remote access](https://docs.dot.ai/gateway/remote) · [Nodes](https://docs.dot.ai/nodes) · [Security](https://docs.dot.ai/gateway/security)
...
Details: [Nodes](https://docs.dot.ai/nodes) · [macOS app](https://docs.dot.ai/platforms/macos) · [Gateway protocol](https://docs.dot.ai/concepts/architecture)
...
Details: [Session tools](https://docs.dot.ai/concepts/session-tool)
...
- Controlled via `dot nodes …`.

Runbook: [iOS connect](https://docs.dot.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.dot.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.dot/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.dot/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.dot/dot.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.dot.ai/gateway/configuration)
...
Details: [Security guide](https://docs.dot.ai/gateway/security) · [Docker + sandboxing](https://docs.dot.ai/install/docker) · [Sandbox config](https://docs.dot.ai/gateway/configuration)

### [WhatsApp](https://docs.dot.ai/channels/whatsapp)

- Link the device: `pnpm dot channels login` (stores creds in `~/.dot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.dot.ai/channels/telegram)
...
### [Slack](https://docs.dot.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.dot.ai/channels/discord)
...
### [Signal](https://docs.dot.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.dot.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.dot.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.dot.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.dot.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.dot.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.dot.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.dot.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.dot.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.dot.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.dot.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.dot.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.dot.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.dot.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.dot.ai/platforms/windows), [Linux](https://docs.dot.ai/platforms/linux), [macOS](https://docs.dot.ai/platforms/macos), [iOS](https://docs.dot.ai/platforms/ios), [Android](https://docs.dot.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.dot.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.dot.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.dot.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.dot.ai/gateway/bonjour)
- [Gateway pairing](https://docs.dot.ai/gateway/pairing)
- [Remote gateway README](https://docs.dot.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.dot.ai/web/control-ui)
- [Dashboard](https://docs.dot.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.dot.ai/gateway/health)
- [Gateway lock](https://docs.dot.ai/gateway/gateway-lock)
- [Background process](https://docs.dot.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.dot.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.dot.ai/logging)

## Deep dives

- [Agent loop](https://docs.dot.ai/concepts/agent-loop)
- [Presence](https://docs.dot.ai/concepts/presence)
- [TypeBox schemas](https://docs.dot.ai/concepts/typebox)
- [RPC adapters](https://docs.dot.ai/reference/rpc)
- [Queue](https://docs.dot.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.dot.ai/tools/skills-config)
- [Default AGENTS](https://docs.dot.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.dot.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.dot.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.dot.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.dot.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.dot.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.dot.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.dot.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.dot.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.dot.ai/platforms/mac/voicewake)
- [iOS node](https://docs.dot.ai/platforms/ios)
- [Android node](https://docs.dot.ai/platforms/android)
- [Windows (WSL2)](https://docs.dot.ai/platforms/windows)
- [Linux app](https://docs.dot.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.dot.ai/gmail-pubsub](https://docs.dot.ai/automation/gmail-pubsub)

## About

Dot is your personal AI assistant that connects all your communication channels.
by the Dot team and community.

- [dot.ai](https://dot.ai)
- [docs.dot.ai](https://docs.dot.ai)
- [@dot](https://x.com/dot)
