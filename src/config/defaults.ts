import type { DotConfig } from "./types.js";
...
function resolveAnthropicDefaultAuthMode(cfg: DotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: DotConfig): DotConfig {
...
export function applyTalkApiKey(config: DotConfig): DotConfig {
...
export function applyModelDefaults(cfg: DotConfig): DotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: DotConfig): DotConfig {
...
export function applyLoggingDefaults(cfg: DotConfig): DotConfig {
...
export function applyContextPruningDefaults(cfg: DotConfig): DotConfig {
...
export function applyCompactionDefaults(cfg: DotConfig): DotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
